...
while not ga.END:
    ...
    for i in range(20):
        ...
        # (7.) remove invalid solution
        Solution.remove_invalid_solution(ga)
        # (8.) filter_solution_pool and ready for new parents
    ...
    ga.seed_radius.add()
    print ("ga.big_generation {} complete...".format(ga.big_generation))
    ga.big_generation += 1
